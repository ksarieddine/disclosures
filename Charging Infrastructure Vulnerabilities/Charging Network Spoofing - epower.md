## Vulnerability Report: Charging Network Spoofing / Session Abuse (ePower)
...
### Summary
A critical set of vulnerabilities has been identified in the ePower epower.ie EV charging management platform, as documented in CISA advisory ICSA-26-062-07. These issues enable unauthenticated station impersonation, session hijacking/shadowing, brute-force authentication attacks, and credential exposure via public mapping platforms.

### Description
The advisory maps to four vulnerabilities:
- **CVE-2026-22552 (CVSS 9.4, CWE-306)**: WebSocket endpoints lack authentication, allowing attackers to impersonate charging stations and issue unauthorized OCPP commands to the backend.
- **CVE-2026-27778 (CVSS 7.5, CWE-307)**: Missing rate limiting on the WebSocket API enables denial-of-service and brute-force authentication attacks.
- **CVE-2026-24912 (CVSS 7.3, CWE-613)**: Predictable/shared station session identifiers allow hijacking or shadowing of legitimate charger sessions.
- **CVE-2026-27770 (CVSS 6.5, CWE-522)**: Charging-station authentication identifiers are publicly accessible via web-based mapping platforms.
...
- **Unauthorized backend access**: Attackers can connect and issue commands without valid credentials (CVE-2026-22552).
- **Service disruption and brute-force exposure**: Repeated authentication traffic can degrade availability and increase credential attack risk (CVE-2026-27778).
- **Session integrity loss**: Shared/predictable station session identifiers can displace legitimate stations and corrupt session state (CVE-2026-24912).
- **Credential exposure**: Publicly available station identifiers increase targeted attack feasibility (CVE-2026-27770).
...
### Reference
- [CISA ICS Advisory ICSA-26-062-07](https://www.cisa.gov/news-events/ics-advisories/icsa-26-062-07)
- [CVE-2026-22552](https://www.cve.org/CVERecord?id=CVE-2026-22552)
- [CVE-2026-27778](https://www.cve.org/CVERecord?id=CVE-2026-27778)
- [CVE-2026-24912](https://www.cve.org/CVERecord?id=CVE-2026-24912)
- [CVE-2026-27770](https://www.cve.org/CVERecord?id=CVE-2026-27770)

### Vendor of Product
- ePower (Ireland) - EV charging management platform (epower.ie)
